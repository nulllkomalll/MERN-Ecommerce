...
const getUserDetails = async (req, res) => {
    try {
        const { userId } = req.body; // Extracting userId from the token via middleware
        const user = await userModel.findById(userId).select("-password"); // Hide the password
...
export { getUserDetails, loginUser, registerUser, loginAdmin };
